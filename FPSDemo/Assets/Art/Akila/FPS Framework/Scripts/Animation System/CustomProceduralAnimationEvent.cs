...
namespace Akila.FPSFramework.Animation
{
    ...
    public class CustomProceduralAnimationEvent
    {
        ...
        /// </summary>
        [Tooltip("Where the event should be called, a location of 0.5 will call the event when the animation is the half of it.")]
        [Range(0.01f, 0.99f)] public float location = 0.01f;
